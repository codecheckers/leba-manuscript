...
documentclass     : "article" #sje: was apa6 - missing on my machine
classoption       : "man"
output            : 
  papaja::apa6_pdf:
    keep_tex: true
...
# add coloured dots and lines on the first column
  ...
  cols_width(
    Stem ~ px(200)) %>%
  gtsave('Figures/Figure3.html') #sje
...
knitr::include_graphics('Figures/orig-Figure2.png') #sje
...
knitr::include_graphics('Figures/orig-Figure3.png') #sje
...
gt_plt_dot(
  ...
  gtsave("Figures/S2_Fig.html") #SJE
